...
- **Brand Assets:**
  - **Logo:** `psychedelicareeu-logo.svg`
  - **Home Page Footer Illustration:** The image at `doctor-HD-cut-1024x1016-1-e1747987254443.jpg` must be kept directly above the footer on the home page. It must not exceed 50% of the page's full width.

# Layout Principles

- **Block Alignment:** Keep layout blocks centered on the page. Inside each block, keep text left aligned.
- **Spacing Scale:**
